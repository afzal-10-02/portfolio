<template>
  <footer class="bg-dark text-white pt-5">
    <div class="container pb-4">
      <div class="row">
        <div class="col-lg-6 mb-4">
          <h4 class="fw-bold mb-3 text-white">Dr. Saroj Kumar</h4>
          <p class="text-white-50">
            Dedicated to providing safe, effective, and result-oriented treatment to patients suffering from acute and chronic pain conditions.
          </p>
        </div>
    ...
    <div class="bg-black py-3 text-center border-top border-secondary">
      <div class="container">
        <small class="text-white-50">&copy; 2025 Dr. Saroj Kumar. All rights reserved.</small>
      </div>
    </div>
  </footer>
</template>
